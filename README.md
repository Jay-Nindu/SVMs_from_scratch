...
I tested my custom SVM classifier by comparing the decision boundaries it generated with the decision boundaries generated by the SVM implemented in the scikitlearn library. Both classifiers were given a dataset consisting of features extracted from iris flowers (sepal width and sepal length), and was tasked with identifying if a flower was of the versicolor species or not.
The sci-kit learn SVM was able to classify 72.5% of flowers correctly using a linear kernel. This increased to 80.83% when using an RBF kernel. See these graphs below:
[!](https://github.com/Jay-Nindu/SVMs_from_scratch/blob/main/scki-kitlearn%20linear%20kernel.png)
[!](https://github.com/Jay-Nindu/SVMs_from_scratch/blob/main/sci-kitlearn%20rbf%20kernel.png)
